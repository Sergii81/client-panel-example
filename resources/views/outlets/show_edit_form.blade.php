...
@section('title',  config('payment_system.app.name') .' :: '.__('outlets.edit.title'))

@section('content')

    <h3 class="page-title">@lang('outlets.edit.page_title')</h3>
    ...
    @include('layouts.partial.page_breadcrumb_add_edit',  [
        ...
        'breadcrumb_text_add_edit'  => __('breadcrumbs.edit.outlets'),
    ])
    ...
    <div class="row">
        <div class="col-md-6 ">
            <div class="portlet-body form">
                ...
                @endif
                <form class="form-horizontal" role="form" method="post" action="{{route('payment_system:outlets.edit')}}">
                    @csrf
                    <input type="hidden" name="outlet_id" value="{{$data['outlet']->id}}">
                    <div class="form-body">
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="name">@lang('outlets.add_edit.label_name')</label>
                            <div class="col-md-9">
                                <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" name="name"
                                        required value="{{$data['outlet']->name}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="outlet_url" name="outlet_url" class="form-control @error('outlet_url') is-invalid @enderror"
                                       placeholder="@lang('outlets.add_edit.placeholder_outlet_url')" required value="{{$data['outlet']->outlet_url}}">
                            </div>
                        </div>
                        <div class="form-group">
                                            ...
                                            <div class="checker">
                                                <span class="">
                                                    <input type="checkbox" name="gateway_{{$gateway->id}}" id="gateway_{{$gateway->id}}" onchange="fun_check()"
                                                           @if($data['outlet']->gateway_1 == $gateway->id || $data['outlet']->gateway_2 == $gateway->id) checked="checked" @endif>
                            ...
                            <div class="col-md-9">
                                <div class="radio-list">
                                    <label class="radio-inline">
                                        <div class="radio">
                                            <span class="">
                                                <input type="radio" name="outlet_status" value="test"
                                                   @if($data['outlet']->outlet_status == 'test') checked="checked" @endif>
                                            </span>
                                        </div>
                                        ...
                                        <div class="radio">
                                            <span class="">
                                                <input type="radio" name="outlet_status" value="active"
                                                       @if($data['outlet']->outlet_status == 'active') checked="checked" @endif>
                                            </span>
                                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="success_url" class="form-control @error('success_url') is-invalid @enderror" name="success_url"
                                       placeholder="@lang('outlets.add_edit.placeholder_success_url')" required value="{{$data['outlet']->success_url}}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="failed_url" class="form-control @error('failed_url') is-invalid @enderror" name="failed_url"
                                       placeholder="@lang('outlets.add_edit.placeholder_failed_url')" required value="{{$data['outlet']->failed_url}}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="callback_url" class="form-control @error('callback_url') is-invalid @enderror" name="callback_url"
                                       placeholder="@lang('outlets.add_edit.placeholder_callback_url')" required value="{{$data['outlet']->callback_url}}">
                            </div>
                        </div>
                    </div>
