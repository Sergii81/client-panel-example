...
@section('title',  config('payment_system.app.name') .' :: '.__('neobanq.title'))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="first_name" class="col-md-12 col-form-label">@lang('neobanq.label_first_name')<sup class="text-danger">@lang('neobanq.star')</sup></label>
                                    <div class="col-md-12">
                                        <input id="first_name" type="text" class="form-control" name="first_name"
                                               value="{{ $transaction->user_first_name ?? ''}}" autofocus placeholder="@lang('neobanq.placeholder_first_name')">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="last_name" class="col-md-12 col-form-label">@lang('neobanq.label_last_name')<sup class="text-danger">@lang('neobanq.star')</sup></label>
                                    <div class="col-md-12">
                                        <input id="last_name" type="text" class="form-control" name="last_name"
                                               value="{{ $transaction->user_last_name ?? ''}}" autofocus placeholder="@lang('neobanq.placeholder_last_name')">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="address" class="col-md-12 col-form-label">@lang('neobanq.label_address')<sup class="text-danger">@lang('neobanq.star')</sup></label>
                                    <div class="col-md-12">
                                        <input id="address" type="text" class="form-control" name="address"
                                               value="{{ $transaction->address ?? '' }}" autofocus placeholder="@lang('neobanq.placeholder_address')">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="country" class="col-md-12 col-form-label">@lang('neobanq.label_country')<sup class="text-danger">@lang('neobanq.star')</sup></label>
                                    <div class="col-md-12">
                                        <select class="form-control" id="country" name="country" autofocus>
                                            <option selected disabled>@lang('neobanq.option_country')</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="state" class="col-md-12 col-form-label">@lang('neobanq.label_state')<sup class="text-danger">@lang('neobanq.star')</sup></label>
                                    <div class="col-md-12">
                                        <input id="state" type="text" class="form-control" name="state"
                                               value="" autofocus placeholder="@lang('neobanq.placeholder_state')">
                                        <span class="help-block">@lang('neobanq.help_state')</span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="city" class="col-md-12 col-form-label">@lang('neobanq.label_city')<sup class="text-danger">@lang('neobanq.star')</sup></label>
                                    <div class="col-md-12">
                                        <input id="city" type="text" class="form-control" name="city"
                                               value="{{ $transaction->city ?? '' }}" autofocus placeholder="@lang('neobanq.placeholder_city')">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="zip" class="col-md-12 col-form-label">@lang('neobanq.label_zip_code')<sup class="text-danger">@lang('neobanq.star')</sup></label>
                                    <div class="col-md-12">
                                        <input id="zip" type="text" class="form-control" name="zip"
                                               value="{{ $transaction->zip ?? '' }}" autofocus placeholder="@lang('neobanq.placeholder_zip_code')">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="email" class="col-md-12 col-form-label">@lang('neobanq.label_email')<sup class="text-danger">@lang('neobanq.star')</sup></label>
                                    <div class="col-md-12">
                                        <input id="email" type="email" class="form-control" name="email"
                                               value="{{$transaction->email ?? ''}}" autofocus placeholder="@lang('neobanq.placeholder_email')">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="phone_no" class="col-md-12 col-form-label">@lang('neobanq.label_phone_no')<sup class="text-danger">@lang('neobanq.star')</sup></label>
                                    <div class="col-md-12">
                                        <input id="phone_no" type="text" class="form-control" name="phone_no"
                                               value="{{$transaction->phone ?? ''}}" autofocus placeholder="@lang('neobanq.placeholder_phone_no')">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div data-label="Card Info" class="df-example demo-table" style="max-width:454px; margin:0 auto;">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
{{--                                    <label for="card_type" class="col-md-12 col-form-label">Select Card <sup class="text-danger">@lang('neobanq.star')</sup></label>--}}
                                    <div class="col-md-12">
...
{{--                                            </select>--}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="amount" class="col-md-12 col-form-label">@lang('neobanq.label_amount')<sup class="text-danger">@lang('neobanq.star')</sup></label>
                                    <div class="col-md-12">
                                        <input id="amount" type="text" class="form-control" value="{{ $transaction->amount ?? ''}}" autofocus
                                               placeholder="@lang('neobanq.placeholder_amount')" disabled="disabled">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="currency" class="col-md-12 col-form-label">@lang('neobanq.label_currency')<sup class="text-danger">@lang('neobanq.star')</sup></label>
                                    <div class="col-md-12">
                                        <input id="currency" type="text" class="form-control" value="{{ $transaction->currency ?? ''}}" autofocus
                                               placeholder="@lang('neobanq.placeholder_currency')" disabled="disabled">
                                        <span class="help-block">@lang('neobanq.help_currency')</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="card_no" class="col-md-12 col-form-label">@lang('neobanq.label_card_no')<sup class="text-danger">@lang('neobanq.star')</sup></label>
                                    <div class="col-md-12">
                                        <input id="card_no" type="text" class="form-control" name="card_no"
                                               value="" autofocus placeholder="@lang('neobanq.placeholder_card_no')" autocomplete="cc-number">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="ccExpiryMonth" class="col-md-12 col-form-label">@lang('neobanq.label_month')<sup class="text-danger">@lang('neobanq.star')</sup></label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" name="ccExpiryMonth" autocomplete="cc-exp-month" placeholder="@lang('neobanq.placeholder_month')">
...
{{--                                        </select>--}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="ccExpiryYear" class="col-md-12 col-form-label">@lang('neobanq.label_year')<sup class="text-danger">@lang('neobanq.star')</sup></label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" name="ccExpiryYear" autocomplete="cc-exp-year" placeholder="@lang('neobanq.placeholder_year')">
...
{{--                                        </select>--}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="cvvNumber" class="col-md-12 col-form-label">@lang('neobanq.label_cvv')<sup class="text-danger">@lang('neobanq.star')</sup></label>
                                    <div class="col-md-12">
                                        <input id="cvvNumber" type="password" class="form-control" name="cvvNumber" value="" autofocus placeholder="@lang('neobanq.placeholder_cvv')">
                                    </div>
                                </div>
                            </div>
                        </div>
